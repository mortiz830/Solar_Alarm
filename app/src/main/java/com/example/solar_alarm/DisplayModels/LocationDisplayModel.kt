...
class LocationDisplayModel(private val _Application: Application, private val _Location: Location?) {
    private var _TimezoneDisplayModel: TimezoneDisplayModel? = null
    fun GetId(): Int {
        return _Location!!.Id
    }
    ...
    fun GetTimezone(): TimezoneDisplayModel {
        if (_TimezoneDisplayModel == null) {
            val timezone = TimezoneRepository(_Application).GetById(_Location!!.Id)
            _TimezoneDisplayModel = TimezoneDisplayModel(timezone)
        }
