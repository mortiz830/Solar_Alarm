...
class TimeZoneResults(var status: String, var message: String, var countryCode: String, var countryName: String, var zoneName: String,
                      var abbreviation: String, var gmtOffset: Int, var dst: Boolean, var zoneStart: Int, var zoneEnd: Int, var nextAbbreviation: String,
                      var timestamp: Int, var formatted: String)